defmodule Victor.Editor.Content do
  ...
  @spec scan_directory(Path.t(), t | Section.t() | Directory.t() | Page.t()) :: {:ok, t | Section.t() | Directory.t() | Page.t()} | {:error, term}
  ...
  @spec scan_file(Path.t(), t | Section.t() | Directory.t() | Page.t()) :: {:ok, t | Section.t() | Directory.t() | Page.t()} | {:error, term}
  ...
  @spec scan_file_for_section(Path.t(), t | Section.t()) :: {:ok, t | Section.t()} | {:error, term}
  ...
  @spec process_paths(list(Path.t()), t | Section.t() | Directory.t() | Page.t()) :: {:ok, t | Section.t() | Directory.t() | Page.t()} | {:error, term}
  ...
  @page_extenions ~w(md markdown mdown asciidoc adoc ad mmark rst pandoc html htm org) |> Enum.map(&".#{&1}")
  ...
  @spec prepend_to_resources(t | Section.t() | Page.t(), Editor.File.t() | Directory.t()) :: {:ok, t | Section.t() | Page.t()}
  defp prepend_to_resources(acc, item) do
    acc = %{acc | resources: [item | acc.resources]}
    {:ok, acc}
  end

  @spec prepend_to_children(t | Directory.t(), Editor.File.t() | Directory.t()) :: {:ok, t | Directory.t()}
